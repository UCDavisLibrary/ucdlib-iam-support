 ...
 */
 class OrgChartTransform{
    ...
    constructor(record, jobInfo){
      ...
      this.data = record;
      this.positionInfo = jobInfo.payload.ppsAssociations[0];
    ...
    get jobType(){
      ...
      if (this.positionInfo.positionType) return this.positionInfo.positionType
    }
    ...
    get jobPercentage(){
      if ( this.isEmpty ) return '';
      if (this.positionInfo.percentFulltime) {
