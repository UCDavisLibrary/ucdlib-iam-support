...
class EmployeeStore extends BaseStore {
  ...
  removeActiveDiscrepancyLoading(request, id, discepanciesList) {
    this._removeActiveDiscrepancy({
      state : this.STATE.LOADING,
      request, id, discepanciesList
    });
  }

  removeActiveDiscrepancyLoaded(payload, id, discepanciesList) {
    this._removeActiveDiscrepancy({
      state : this.STATE.LOADED,
      payload, id, discepanciesList
    });
  }

  removeActiveDiscrepancyError(error, id, discepanciesList) {
    this._removeActiveDiscrepancy({
      state : this.STATE.ERROR,
      error, id, discepanciesList
    });
  }
