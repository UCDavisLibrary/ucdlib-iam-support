...
CLI_IMAGE_NAME=$CONTAINER_REG_ORG/itis-iam-support-cli
LIB_IMAGE_NAME=$CONTAINER_REG_ORG/itis-iam-support-lib

APP_IMAGE_NAME_TAG=$APP_IMAGE_NAME:$REPO_TAG
CLI_IMAGE_NAME_TAG=$CLI_IMAGE_NAME:$REPO_TAG
LIB_IMAGE_NAME_TAG=$LIB_IMAGE_NAME:$REPO_TAG

ALL_DOCKER_BUILD_IMAGES=( $APP_IMAGE_NAME $CLI_IMAGE_NAME $LIB_IMAGE_NAME )
